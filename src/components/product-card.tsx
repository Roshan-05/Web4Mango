    ...
    <div className=" flex flex-col gap-2 p-2 rounded-lg shadow-md max-w-80 m-40">
      <div className=" relative group overflow-y-hidden ">
        ...
        <div className="bg-yellow flex justify-around py-3">
          {
            isHovered? 
<Image src="/fast-cart-white.png" width={25} height={25} alt="shopping cart" onMouseLeave={handleMouseLeave} />
:
<Image src="/fast-cart-black.png" width={25} height={25} alt="shopping cart" onMouseEnter={handleMouseEnter} />
