...
export default function Compliments() {
  ...
  return (
    <section className="h-screen max-h-[700px] max-w-7xl mx-auto bg-yellow w-full py-14 box-border">
      <div className="  text-center w-full px-96 min-w-72 py-2">
        <p className="text-5xl font-bold   mb-6" style={{ lineHeight: "1.2" }}>
          Creamy Compliments
        </p>
        <p className="text-line font-semibold">
          We&apos;re proud of our product, and we&apos;re really excited when
          they get a feedback from the customers.
        </p>
      </div>
